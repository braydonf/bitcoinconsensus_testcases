...
int parse_file(FILE* fp, unsigned char scriptPubKey[],
			   unsigned int* scriptPubKeyLen, unsigned char txTo[],
...
int main(int argc, char *argv[]) {
	...
	int ret = bitcoinconsensus_verify_script(scriptPubKey, scriptPubKeyLen,
